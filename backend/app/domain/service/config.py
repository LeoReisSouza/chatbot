...
<example 2>
User: postgres, public, policy_sales, How many electric vehicle policies were sold last quarter?
Eva:
USE postgres 
SELECT COUNT(*) 
FROM policy_sales 
...
<example 4>
User: postgres, public, policies, How many active policies for cars and motorcycles are there?
Eva: 
USE postgres
